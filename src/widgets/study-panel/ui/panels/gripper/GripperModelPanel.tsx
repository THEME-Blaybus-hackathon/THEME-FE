  ...
  return (
    <>
      <div style={{ width: '100%', height: 180, marginBottom: 20 }}>
        <img src={GripperSvg} alt="Precision Gripper" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
      </div>
      ...
      <p style={{ opacity: 0.9, lineHeight: 1.6, marginBottom: 20 }}>
        ...
        다양한 형상의 물체를 안정적으로 취급할 수 있도록 설계되었습니다.
      </p>
      ...
      <Section>
        ...
        <SectionText>
          ...
          파지 중 미끄러짐을 최소화하고 안정적인 물체 고정을 제공합니다.
        </SectionText>
      </Section>
      ...
      <Section>
        ...
        <SectionText>
          ...
          로봇 암과의 연동 동작 이해를 위한 교육·연구용 모델입니다.
        </SectionText>
      </Section>
    </>
  );
