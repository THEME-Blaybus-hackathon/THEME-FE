  ...
  return (
    <>
      <div style={{ width: '100%', height: 180, marginBottom: 20 }}>
        <img src={ArmSvg} alt="6-Axis Robot Arm" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
      </div>
      ...
      <p style={{ opacity: 0.9, lineHeight: 1.6, marginBottom: 20 }}>
        본 모델은 <Highlight>6축 다관절 구조</Highlight>를 기반으로 설계된
      ...
      <Section>
        ...
        <SectionText>
          ...
          지지하며, 반복 정밀도는 약 <Highlight> ±0.02mm</Highlight> 수준으로
          고정밀 작업 시뮬레이션에 적합합니다.
        </SectionText>
      </Section>
