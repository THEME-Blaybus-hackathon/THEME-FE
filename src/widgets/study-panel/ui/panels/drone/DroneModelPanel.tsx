  ...
  return (
    <>
      ...
      <p style={{ opacity: 0.9, lineHeight: 1.6, marginBottom: 20 }}>
        본 모델은 <Highlight>4-Rotor 멀티로터 구조</Highlight>를 기반으로 설계된
        교육·연구용 UAV로, 비행 제어 시스템과 기계 구조의 상호작용을
        직관적으로 학습할 수 있도록 최적화되었습니다.
      </p>

      <div style={{ display: 'grid', gridTemplateColumns: '72px 1fr', rowGap: 12, columnGap: 12, marginBottom: 24 }}>
...
function Highlight({ children }: { children: React.ReactNode }) {
  return (
    <span style={{ color: '#202059', fontWeight: 800, background: 'rgba(155, 178, 255, 0.35)', padding: '2px 6px', borderRadius: 6, margin: '0 2px' }}>
      {children}
    </span>
  );
}
